...
power = col2.number_input("Podaj moc w KM:", value=0, min_value=0, max_value=1000, step=1)
...
age = col2.slider("Rok produkcji:", value=2022, min_value=1992, max_value=2022, step=1) #tranform into age
...
#brand = col3.text_input("Marka sam")
#model = col4.text_input("Model sam")
...
doors = col1.select_slider("Liczba drzwi:", [2, 3, 4, 5, 6], value=5)
seats = col2.select_slider("Liczba siedzeń:", [2, 3, 4, 5, 6, 7, 8, 9], value=5)

condition = col3.selectbox("Stan:", ["Nowe", "Używane"])
car_type = col4.selectbox("Typ samochodu:", ["Auta małe", "Auta miejskie", "Coupe", "Kabriolet", "Kombi", "Kompakt", "Minivan", "Sedan", "SUV"])
...
df_pred=pd.DataFrame([[doors,seats,cylinder_capacity,fuel,power,transmission,mileage,age,brand,model,no_crash,condition,color,country,zawieszenie, startstop, ogrzewane_siedzenie_tylne, klimatyzacja_4strefowa, kamera_parkowania, ogrzewanie_postojowe, czujnik_martwego_pola, kamera_w_lusterku, przyciemniane_szyby, lane_assist, tempomat_adaptacyjny, wspomaganie_kierownicy, podgrzewana_przednia_szyba, ogranicznik_predkosci, tapicerka_skorzana, car_type, district, drive, registered, klimatyzacja_2strefowa, elektryczne_szyby_przednie, lusterka_boczne_elektryczne, system_nawigacji_sat, podgrzewane_lusterka_boczne, elektryczny_fotel_kierowcy, elektryczny_fotel_pasazera, podgrzewany_fotel_kierowcy, colour_type]], 
                    columns=['doors','seats','cylinder_capacity', 'fuel', 'power', 'transmission', 'mileage', 'age', 'brand', 'model', 'no_crash', 'condition', 'color', 'country', 'Zawieszenie regulowane', 'System StartStop', 'Ogrzewane siedzenia tylne', 'Klimatyzacja automatyczna 4 lub wicej strefowa','Kamera parkowania tył', 'Ogrzewanie postojowe', 'Asystent (czujnik) martwego pola', 'Kamera w lusterku bocznym','Przyciemniane tylne szyby', 'Lane assist - kontrola zmiany pasa ruchu', 'Tempomat adaptacyjny ACC', 'Wspomaganie kierownicy','Podgrzewana przednia szyba', 'Ogranicznik prdkoci', 'Tapicerka skrzana', 'car_type', 'district', 'drive', 'registered', 'Klimatyzacja automatyczna dwustrefowa','Elektryczne szyby przednie', 'Lusterka boczne ustawiane elektrycznie', 'System nawigacji satelitarnej','Podgrzewane lusterka boczne', 'Elektrycznie ustawiany fotel kierowcy', 'Elektrycznie ustawiany fotel pasaera', 'Podgrzewany fotel kierowcy', "colour_type"])




#df_pred=pd.read_csv("test_model.csv")
